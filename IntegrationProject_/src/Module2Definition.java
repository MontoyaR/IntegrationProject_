...
public class Module2Definition {
  ...
  public static void selection6() {
    ...
    System.out
        .println("Variables in a method or block of code: \n \t These are called local variables.");
    System.out.println("Variables in method declarations: \n \t These are called parameters.");
    System.out.println();
    System.out
        .println("\t The scope refers to the section of code where a variable can be accessed. \n");
  }
}
